...
if(!extension_loaded('appoptics') && !function_exists('appoptics_set_context')) {
     ...
     * @return boolean (true on success, false on failure)
     */
    function appoptics_log_error($layer, $message, $code, $info = true, $backtrace = true, $edge = null) {
        return false;
    }
     ...
     * @return boolean (true on success, false on failure)
     */
    function appoptics_log_exception($layer, Exception $e, $info = null, $backtrace = true, $edge = null) {
        return false;
    }
